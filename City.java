...
public class City{
     ...
     * @return A HashMap of Hashsets that reprsents the connections in this city as an adjacency list.
     */
     ...
     * A method that returns a HashSet of all the uncovered neighbors of a specified communtiy.
     * @param community The specified community in this city.
    ...
    /**
     * addFireStation
     * A method that adds a fire staton to a certian community in this city and updates its neighbours as covered
     * accourdingly.
